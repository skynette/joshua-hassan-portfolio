        ...
        >
            <div className="flex items-center justify-center">
                <div className="relative">
                    ...
                    >
                        <Image
                            src="https://avatars.githubusercontent.com/u/29153968?v=4"
                            alt="Joshua Hassan"
                            width="192"
                            height="192"
                            quality="95"
            ...
            >
                ...
                <a
                    ...
                    href="https://twitter.com/cut3josh"
                    target="_blank"
                >
                    <BsTwitter />
                </a>
                <a
                    className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
                    href="https://www.linkedin.com/in/joshua-hassan-01b443179/"
                    target="_blank"
                >
                    <BsLinkedin />
                </a>
                ...
                <a
                    ...
                    href="https://github.com/skynette"
                    target="_blank"
                >
                    <FaGithubSquare />
                </a>
